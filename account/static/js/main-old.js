...
// const typeItem = document.querySelectorAll('.personal .type__item');
// console.log(typeItem);
// typeItem.forEach(elem => {
//   elem.addEventListener('click', function (e) {
//     console.log( elem.querySelector('.radio__wrap input'));
//     console.log( elem.querySelector('.radio__wrap'));
//     if(elem.querySelector('.radio__wrap input').checked){
//       elem.querySelector('.radio__wrap input').checked
//     } else{
//       elem.querySelector('.radio__wrap').classList.remove('radio__wrap_checked')
//     }
...
// const showFile = document.querySelector('.show_file')
